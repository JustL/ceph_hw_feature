...
#ifndef CEPH_HWMESSENGER_H
#define CEPH_HWMESSENGER_H
...
/**
 * If the Messenger accepts new connections, it runs a process
 * that handles new incoming requests.
 */
class Processor 
{

 public:
  Processor(HwMessengerr *r, Worker *w, CephContext *c)
  : msgr(r), worker(w), cct(c)
  {}
