...
void RDMAReliableConnected::maybe_start_delay_thread()
{
  if (!delay_state) {
                                            ...
                                            bufferlist &authorizer_reply)
{
  ...
  RDMAReliableConnectedRef existing = dynamic_cast<RDMAReliableConectedRef>(async_msgr->lookup_conn(peer_addr));
